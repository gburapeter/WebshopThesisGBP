        ...
        <a
            ...
            className={`sm:px-6 py-3 w-1/2 sm:w-auto ${
                props.currentStep == index + 1
                    ...
                    : ""
            } justify-center cursor-pointer sm:justify-start border-b-2  title-font font-medium bg-gray-100 inline-flex items-center leading-none  text-indigo-800 tracking-wider rounded-t `}
        >
            {step.icon}
            {step.title}
        </a>
